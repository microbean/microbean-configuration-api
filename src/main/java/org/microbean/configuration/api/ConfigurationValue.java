...
/**
 * A value for a configuration property, particularly as {@linkplain
 * AmbiguousConfigurationValuesException#getValues() exposed} by an
 * {@link AmbiguousConfigurationValuesException}.
 *
 * @author <a href="http://about.me/lairdnelson"
 * target="_parent">Laird Nelson</a>
 *
 * @see AmbiguousConfigurationValuesException
 */
public class ConfigurationValue implements Serializable {
  ...
  /**
   * The system that produced this {@link
   * ConfigurationValue}.
   *
   ...
   *
   * @param source the system creating this {@link
   * ConfigurationValue}; must not be {@code null}
   *
   ...
   *
   * @exception NullPointerException if either {@code source}
   * or {@code name} is {@code null}
   */
  public ConfigurationValue(final Serializable source, final Map<String, String> coordinates, final String name, final String value, final boolean authoritative) {
    super();
  ...
  /**
   * Returns the system that created this {@link ConfigurationValue}.
   *
   * <p>This method never returns {@code null}.</p>
   *
   * @return the system that created this {@link ConfigurationValue};
   * never {@code null}
   */
  ...
  public int hashCode() {
    ...
    // Note: getSource() and isAuthoritative() are deliberately
  ...
  public boolean equals(final Object other) {
    if (other == this) {
      ...
      // Note: getSource() and isAuthoritative() are
